//Initialize Firebase
  ...
  var config = {
    apiKey: "AIzaSyAIfv6GTUekFeKiAitIAYgX_H5dsZJ-0hE",
    authDomain: "train-scheduler-2b57b.firebaseapp.com",
    databaseURL: "https://train-scheduler-2b57b.firebaseio.com",
    projectId: "train-scheduler-2b57b",
    storageBucket: "train-scheduler-2b57b.appspot.com",
    messagingSenderId: "779252218793"
  };

  firebase.initializeApp(config);

//Var to represent firebase database
  var database = firebase.database();

//Button to submit train info provided by the user
  $("#formID").on("submit", function (event) {
  		event.preventDefault();

//Create user input values here
...
//Firebase function for when user adds train data
...
//Current time and time apart calculations for next train
